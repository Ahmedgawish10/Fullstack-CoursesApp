...
function CardCourse({ allCourses }) {
  ...
  return (
    <div className="card_courses grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 p-2 container_courses">
          ...
          <div className="img">
            <div className="course-overlay flex-col gap-4">
              ...
              {course.attributes.discount ? (
                <button className="button-85 mt-2 flex items-center" type="button" onClick={() => handleAddToCart(course)}>
                  <span>
                ...
                <button className="button-85 mt-2 flex items-center" type="button" onClick={() => { handleViewCourse(course.id); }}>
                  <span>
